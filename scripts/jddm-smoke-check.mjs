...
assertCheck('Dee Dee reminders use the spreadsheet-backed delivery queue', /modules\/deeDeeReminders\.js/.test(indexHtml) && /queueReminder/.test(read('modules/deeDeeReminders.js')));
