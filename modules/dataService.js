...
const CSV_COLUMNS = {
    ...
    LAST_CONTACTED_DATE: ['Last Contacted', 'lastContactedDate', 'last contacted date', 'Contacted'],
    NEXT_FOLLOW_UP_DATE: ['Next Follow Up', 'NextFollowUp', 'nextFollowUpDate', 'next follow up date', 'next follow-up date'],
